...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    font = ImageFont.truetype("etc/basefont.otf", 32)
...
async def play(_, message: Message):
    ...
    if message.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        photo="final.png", 
        caption=f"#⃣ ʏᴏᴜʀ ʀᴇǫᴜᴇsᴛᴇᴅ sᴏɴɢ **ǫᴜᴇᴜᴇᴅ** ᴀᴛ ᴘᴏsɪᴛɪᴏɴ {position}!",
        ...
        photo="final.png",
        reply_markup=keyboard,
        caption="▶️ **ᴘʟᴀʏɪɴɢ** ʜᴇʀᴇ ᴛʜᴇ sᴏɴɢ ʀᴇǫᴜᴇsᴛᴇᴅ ʙʏ {}".format(
